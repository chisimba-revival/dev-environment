...
PYTHON="$TOOLS/audit-auth-language-stack-fast.py"
OUT="$ROOT/killme.txt"

JSON="$REPORTS/liveuser-language-dependency-audit.json"
TEXT="$REPORTS/liveuser-language-dependency-audit.txt"
MARKDOWN="$REPORTS/liveuser-language-dependency-audit.md"
...
rm -f "$JSON" "$TEXT" "$MARKDOWN"

{
    echo "============================================================"
    echo "FAST BOUNDED AUTHENTICATION AND LANGUAGE-STACK AUDIT"
    echo "============================================================"
    echo
